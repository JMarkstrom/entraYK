    ...
    return @(
        ...
        @{Model="YubiKey 5 NFC"; Firmware="5.7.4"; AAGUID="d7781e5d-e353-46aa-afe2-3ca49f13332a"; Certification="Level 2"},
        ...
        @{Model="YubiKey 5 NFC FIPS"; Firmware="5.7.4"; AAGUID="fcc0118f-cd45-435b-8da1-9782b2da0715"; Certification="Level 2"}, # FIPS RC
        @{Model="YubiKey 5 NFC FIPS"; Firmware="5.7.4"; AAGUID="79f3c8ba-9e35-484b-8f47-53a5a0f5c630"; Certification="Level 2"}, # FIPS RC, EA capable        
        @{Model="YubiKey 5 NFC"; Firmware="5.7"; AAGUID="1ac71f64-468d-4fe0-bef1-0e5f2f551f18"; Certification="Level 2"}, # EA capable
        @{Model="YubiKey 5 NFC"; Firmware="5.7.4"; AAGUID="6ab56fad-881f-4a43-acb2-0be065924522"; Certification="Level 2"}, # EA capable
        ...
        @{Model="YubiKey 5C NFC"; Firmware="5.7.4"; AAGUID="d7781e5d-e353-46aa-afe2-3ca49f13332a"; Certification="Level 2"},
        ...
        @{Model="YubiKey 5C NFC FIPS"; Firmware="5.7.4"; AAGUID="fcc0118f-cd45-435b-8da1-9782b2da0715"; Certification="Level 2"}, # FIPS RC
        @{Model="YubiKey 5C NFC FIPS"; Firmware="5.7.4"; AAGUID="79f3c8ba-9e35-484b-8f47-53a5a0f5c630"; Certification="Level 2"}, # FIPS RC, EA capable  
        @{Model="YubiKey 5C NFC"; Firmware="5.7"; AAGUID="1ac71f64-468d-4fe0-bef1-0e5f2f551f18"; Certification="Level 2"}, # EA capable
        @{Model="YubiKey 5C NFC"; Firmware="5.7.4"; AAGUID="6ab56fad-881f-4a43-acb2-0be065924522"; Certification="Level 2"}, # EA capable       
        ...
        @{Model="YubiKey 5 Nano"; Firmware="5.7.4"; AAGUID="ff4dac45-ede8-4ec2-aced-cf66103f4335"; Certification="Level 2"},
        ...
        @{Model="YubiKey 5 Nano FIPS"; Firmware="5.7.4"; AAGUID="57f7de54-c807-4eab-b1c6-1c9be7984e92"; Certification="Level 2"}, # FIPS RC
        @{Model="YubiKey 5 Nano FIPS"; Firmware="5.7.4"; AAGUID="905b4cb4-ed6f-4da9-92fc-45e0d4e9b5c7"; Certification="Level 2"}, # FIPS RC, EA capable
        @{Model="YubiKey 5 Nano"; Firmware="5.7"; AAGUID="20ac7a17-c814-4833-93fe-539f0d5e3389"; Certification="Level 2"}, # EA capable
        @{Model="YubiKey 5 Nano"; Firmware="5.7.4"; AAGUID="4599062e-6926-4fe7-9566-9e8fb1aedaa0"; Certification="Level 2"}, # EA capable
        ...
        @{Model="YubiKey 5C Nano"; Firmware="5.7.4"; AAGUID="ff4dac45-ede8-4ec2-aced-cf66103f4335"; Certification="Level 2"},
        ...
        @{Model="YubiKey 5C Nano FIPS"; Firmware="5.7.4"; AAGUID="57f7de54-c807-4eab-b1c6-1c9be7984e92"; Certification="Level 2"}, # FIPS RC
        @{Model="YubiKey 5C Nano FIPS"; Firmware="5.7.4"; AAGUID="905b4cb4-ed6f-4da9-92fc-45e0d4e9b5c7"; Certification="Level 2"}, # FIPS RC, EA capable
        @{Model="YubiKey 5C Nano"; Firmware="5.7"; AAGUID="20ac7a17-c814-4833-93fe-539f0d5e3389"; Certification="Level 2"}, # EA capable
        @{Model="YubiKey 5C Nano"; Firmware="5.7.4"; AAGUID="4599062e-6926-4fe7-9566-9e8fb1aedaa0"; Certification="Level 2"}, # EA capable
        # YubiKey 5C (USB-C)
        ...
        @{Model="YubiKey 5C"; Firmware="5.7.4"; AAGUID="ff4dac45-ede8-4ec2-aced-cf66103f4335"; Certification="Level 2"},
        ...
        @{Model="YubiKey 5C FIPS"; Firmware="5.7.4"; AAGUID="57f7de54-c807-4eab-b1c6-1c9be7984e92"; Certification="Level 2"}, # FIPS RC
        @{Model="YubiKey 5C FIPS"; Firmware="5.7.4"; AAGUID="905b4cb4-ed6f-4da9-92fc-45e0d4e9b5c7"; Certification="Level 2"}, # FIPS RC, EA capable
        @{Model="YubiKey 5C"; Firmware="5.7"; AAGUID="20ac7a17-c814-4833-93fe-539f0d5e3389"; Certification="Level 2"}, # EA capable
        @{Model="YubiKey 5C"; Firmware="5.7.4"; AAGUID="4599062e-6926-4fe7-9566-9e8fb1aedaa0"; Certification="Level 2"}, # EA capable
        # YubiKey 5Ci
        ...
        @{Model="YubiKey 5Ci"; Firmware="5.7.4"; AAGUID="24673149-6c86-42e7-98d9-433fb5b73296"; Certification="Level 2"},
        ...
        @{Model="YubiKey 5Ci FIPS"; Firmware="5.7.4"; AAGUID="7b96457d-e3cd-432b-9ceb-c9fdd7ef7432"; Certification="Level 2"}, # FIPS RC
        @{Model="YubiKey 5Ci FIPS"; Firmware="5.7.4"; AAGUID="3a662962-c6d4-4023-bebb-98ae92e78e20"; Certification="Level 2"}, # FIPS RC, EA capable
        ...
        @{Model="YubiKey Bio FIDO Ed."; Firmware="5.7.4"; AAGUID="7409272d-1ff9-4e10-9fc9-ac0019c124fd"; Certification="Level 2"},
        @{Model="YubiKey Bio FIDO Ed."; Firmware="5.7"; AAGUID="8c39ee86-7f9a-4a95-9ba3-f6b097e5c2ee"; Certification="Level 2"}, #EA capable
        @{Model="YubiKey Bio FIDO Ed."; Firmware="5.7.4"; AAGUID="ad08c78a-4e41-49b9-86a2-ac15b06899e2"; Certification="Level 2"}, #EA capable
        ...
        @{Model="YubiKey Bio MPE"; Firmware="5.7.4"; AAGUID="34744913-4f57-4e6e-a527-e9ec3c4b94e6"; Certification="Level 2"},
        @{Model="YubiKey Bio MPE"; Firmware="5.7"; AAGUID="97e6a830-c952-4740-95fc-7c78dc97ce47"; Certification="Level 2"}, #EA capable
        @{Model="YubiKey Bio MPE"; Firmware="5.7.4"; AAGUID="6ec5cff2-a0f9-4169-945b-f33b563f7b99"; Certification="Level 2"}, #EA capable
        ...
        @{Model="Security Key NFC"; Firmware="5.7.4"; AAGUID="b7d3f68e-88a6-471e-9ecf-2df26d041ede"; Certification="Level 2"},
        ...
        @{Model="Security Key NFC Enterprise Ed."; Firmware="5.7.4"; AAGUID="ed042a3a-4b22-4455-bb69-a267b652ae7e"; Certification="Level 2"},
        ...
        @{Model="Security Key NFC Enterprise Ed."; Firmware="5.7.4"; AAGUID="6ab56fad-881f-4a43-acb2-0be065924522"; Certification="Level 2"} # EA capable
    )
} 